      ...
      aside={
        <>
          <div className="rounded-3xl border border-white/8 bg-[#0f1221]/80 p-5">
            ...
            <p className="mt-2 text-sm text-[#8B89A8]">Your verification code is valid for 10 minutes.</p>
          </div>
          <div className="rounded-3xl border border-white/8 bg-[#0f1221]/80 p-5">
      ...
      <div className="flex flex-col gap-6">
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Check your inbox and type the 6-digit code from the email you received.
            </CardDescription>
          </CardHeader>
          <CardContent>
              ...
              <FieldGroup>
                  ...
                  <div className="grid grid-cols-6 gap-3">
                    {Array.from({ length: 6 }).map((_, index) => (
                      <Input
                        ...
                        pattern="[0-9]*"
                        maxLength={1}
                        className="h-14 rounded-xl border-white/10 bg-[#0f1221] text-center text-lg font-semibold tracking-[0.35em]"
                      />
                    ))}
                  </div>
                </Field>
                <Field>
                  ...
                  <FieldDescription className="text-center">
                    Didn&apos;t receive a code? <a href="/forgot-password">Try another email</a>
                  </FieldDescription>
                </Field>
              </FieldGroup>
            </form>
