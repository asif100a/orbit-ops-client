...
type CompanyFormValues = {
  ...
  industryType: (typeof companyIndustryOptions)[number];
  logo: string;
  website: string;
  email: string;
  phoneNumber: string;
...
export default function CreateCompanyPage() {
  ...
  const onSubmit = async (data: CompanyFormValues) => {
    try {
      const normalizedLogo = data.logo.trim();
      ...
      const companyId = response.data?._id ?? response.data?.id;
      if (!companyId) {
      ...
      toast.error(message || "Unable to create company. Please try again.");
    }
  };
            ...
            <FieldGroup>
              ...
              <div className="grid gap-5 sm:grid-cols-2">
                <Field>
                  ...
                  <select
                    id="company-industry"
                    className="h-11 w-full rounded-lg border border-white/[0.08] bg-white/[0.035] px-3 text-sm text-white outline-none transition focus:border-violet-500/50"
                    disabled={isFormLoading}
                    {...register("industryType", {
                      required: "Industry type is required",
                      validate: (value) =>
                        companyIndustryOptions.includes(
                          value as (typeof companyIndustryOptions)[number],
                ...
                <Field>
                  ...
                  <div className="relative">
                    ...
                    >
                      ...
                      <option className="bg-[#12121e]" value="201-500">
                        201-500 people
                      </option>
                      <option className="bg-[#12121e]" value="500+">
                        500+ people
                      </option>
                    </select>
                  </div>
              ...
              <div className="grid gap-5 sm:grid-cols-2">
                <Field>
                  <FieldLabel htmlFor="company-email" className="text-white">
                    Company email
                  </FieldLabel>
                  <div className="relative">
                ...
                <Field>
                  <FieldLabel htmlFor="company-phone" className="text-white">
                    Phone number
                  </FieldLabel>
                  <div className="relative">
              ...
              <div className="border-t border-white/[0.06] pt-5">
                ...
                <div className="grid gap-5 sm:grid-cols-2">
                  <Field>
                    <FieldLabel htmlFor="company-street" className="text-white">
                      Street
                    </FieldLabel>
                    <Input
                      id="company-street"
                  ...
                  <Field>
                    <FieldLabel htmlFor="company-city" className="text-white">
                      City
                    </FieldLabel>
                    <Input
                      id="company-city"
                  ...
                  <Field>
                    <FieldLabel htmlFor="company-state" className="text-white">
                      State
                    </FieldLabel>
                    <Input
                      id="company-state"
              ...
              <div className="border-t border-white/[0.06] pt-5">
                ...
                <div className="grid gap-5 sm:grid-cols-2">
                  ...
                  <Field>
                    <FieldLabel htmlFor="company-plan" className="text-white">
                      Plan
                    </FieldLabel>
                    <select
                      id="company-plan"
                    ...
                    >
                      <option className="bg-[#12121e]" value="FREE">
                        Free
                      </option>
                    </select>
                  </Field>
                  <Field>
                    ...
                    <Input
                      ...
                      type="time"
                      className="h-11 border-white/[0.08] bg-white/[0.035] text-white"
                      disabled={isFormLoading}
                      {...register("settings.workingHoursStart", {
                  ...
                  <Field>
                    ...
                    <Input
                      ...
                      className="h-11 border-white/[0.08] bg-white/[0.035] text-white"
                      disabled={isFormLoading}
                      {...register("settings.workingHoursEnd", {
                ...
                <div className="mt-5 flex flex-wrap gap-2">
                  {workingDays.map((day) => (
                    <label
                      key={day}
                      className="flex cursor-pointer items-center gap-2 rounded-lg border border-white/[0.08] bg-white/[0.025] px-3 py-2 text-xs text-[#D9D7EA]"
                    >
                      <input
                        type="checkbox"
                        value={day}
                        defaultChecked
                        {...register("settings.workingDays")}
                      />
                      {day.slice(0, 3)}
                    </label>
                  ))}
                ...
                <label className="mt-4 flex items-center gap-2 text-sm text-[#D9D7EA]">
                  <input
                    type="checkbox"
                    {...register("settings.allowSelfRegistration")}
                  />
        ...
        <aside className="rounded-2xl border border-white/[0.07] bg-[#0d0d18]/80 p-5">
          ...
          <div className="mt-7 rounded-xl border border-teal-300/15 bg-teal-400/[0.06] p-4">
            ...
            <p className="mt-2 text-xs leading-5 text-[#8B89A8]">
              The logged-in user becomes the company owner and can invite
