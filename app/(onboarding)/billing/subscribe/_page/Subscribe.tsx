    ...
    <OnboardingStepGuard step="subscribe">
      <div className="space-y-6">
        <section className="flex flex-col justify-between gap-4 sm:flex-row sm:items-end">
          <div>
            ...
            <p className="mt-2 max-w-2xl text-sm leading-6 text-[#8B89A8]">
              Choose a plan to unlock the dashboard, member invitations,
              projects, and admin controls for your company.
            </p>
          </div>
        ...
        <section className="grid gap-4 lg:grid-cols-3">
          {plans.map((plan) => {
            const isSelected = selectedPlan === plan.name?.toUpperCase();
            ...
            return (
              <button
                ...
                type="button"
                onClick={() =>
                  setSelectedPlan(plan.name.toUpperCase() as SubscriptionType)
                }
              ...
              >
                ...
                <div className="mt-5 flex items-end gap-1">
                  ...
                  <span className="pb-1 text-sm text-[#686681]">per month</span>
                </div>
